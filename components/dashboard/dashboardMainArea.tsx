    ...
    useEffect(() => {
        const getData = async () => {
            try {
                ...
                setCastingData(data);
              // setProcesWeight()   // here i need to set the processing weight  where thr received weight is Zero or null
        ...
        <div className="w-full bg-white rounded-lg shadow-sm p-4">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                    <button
                        className={`px-3 py-1 text-xs font-medium rounded-md ${dateRange === "day"
                    ...
                    <button
                        className={`px-3 py-1 text-xs font-medium rounded-md ${dateRange === "week"
                                ? "bg-primary text-white"
                                : "bg-gray-100 text-slate-600"}`}
                    ...
                    <button
                        className={`px-3 py-1 text-xs font-medium rounded-md ${dateRange === "month"
                                ? "bg-primary text-white"
                                : "bg-gray-100 text-slate-600"}`}
                    ...
                    <button
                        className={`px-3 py-1 text-xs font-medium rounded-md ${dateRange === "custom"
                                ? "bg-primary text-white"
                                : "bg-gray-100 text-slate-600"}`}
